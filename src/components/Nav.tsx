    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8 h-14 sm:h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <a
            href="#buy"
            className="hidden sm:inline-flex items-center gap-2 rounded-sm bg-ink text-cream px-5 py-2.5 text-sm font-medium hover:bg-ink/90 transition-colors"
          >
            להזמין עכשיו
      ...
      >
        <nav className="px-5 pb-6 pt-2 flex flex-col gap-4 text-base border-t border-line/50 bg-cream/95 backdrop-blur">
          ...
          <a
            href="#buy"
            onClick={() => setOpen(false)}
            className="mt-1 inline-flex items-center justify-center gap-2 rounded-sm bg-ink text-cream px-5 py-3 text-sm font-medium"
          >
            להזמין עכשיו
            <span aria-hidden>←</span>
          </a>
