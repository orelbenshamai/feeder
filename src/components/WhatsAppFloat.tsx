...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] start-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_15px_40px_-10px_rgba(37,211,102,0.55)] transition-transform duration-300 hover:scale-110 md:bottom-7 md:start-7 md:h-14 md:w-14"
    >
      <span
