        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] lg:gap-10">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-start">
            ...
            <p className="-mt-6 max-w-xs text-lg leading-relaxed sm:max-w-sm sm:text-xl">
              <span style={{ fontFamily: "var(--font-nunito)" }}>MESUDAR</span> פיתחה פתרונות האכלה שתוכננו לשמור על פינת האכילה נקייה ומסודרת.
              עמדת ההאכלה המוגבהת מפרידה בין מזון ומים שנשפכים, כך שהם מתנקזים הצידה —
              ולא על הרצפה שלכם.
              בשילוב משטח ההאכלה שמכיל פירורים והתזות, ארוחת הכלב נשארת מרוכזת במקום אחד,
