    ...
    <svg viewBox="0 0 400 500" className="absolute inset-0 h-full w-full" aria-hidden>
      <defs>
        ...
        <linearGradient id="kit-floor" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#E0D5C2" />
          <stop offset="100%" stopColor="#C8B79A" />
        </linearGradient>
      </defs>
      <rect width="400" height="500" fill="url(#kit-wall)" />
      <rect x="0" y="240" width="400" height="60" fill="url(#kit-counter)" />
      <rect x="0" y="298" width="400" height="6" fill="#D6C9B2" />
      <rect x="0" y="304" width="400" height="200" fill="url(#kit-floor)" />
      <rect x="40" y="40" width="120" height="160" rx="6" fill="#FAF6EF" opacity="0.6" />
      <rect x="40" y="40" width="120" height="160" rx="6" fill="none" stroke="#D6C9B2" strokeWidth="1" />
      <line x1="100" y1="40" x2="100" y2="200" stroke="#D6C9B2" strokeWidth="1" />
      <line x1="40" y1="120" x2="160" y2="120" stroke="#D6C9B2" strokeWidth="1" />
      <ellipse cx="280" cy="240" rx="14" ry="3" fill="#B5896F" opacity="0.4" />
      <path d="M270 238 Q270 210 280 210 Q290 210 290 238 Z" fill="#B5896F" opacity="0.6" />
      <path d="M280 210 Q278 195 274 188 M280 210 Q282 196 286 190 M280 210 Q280 192 280 184" stroke="#7C766E" strokeWidth="1.2" fill="none" />
    </svg>
  );
}
    ...
    <svg viewBox="0 0 400 500" className="absolute inset-0 h-full w-full" aria-hidden>
      <defs>
        ...
        <linearGradient id="lv-floor" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#D6C9B2" />
          <stop offset="100%" stopColor="#B89F7B" />
        </linearGradient>
      </defs>
      <rect width="400" height="500" fill="url(#lv-wall)" />
      <rect x="0" y="320" width="400" height="180" fill="url(#lv-floor)" />
      <rect x="40" y="180" width="200" height="120" rx="14" fill="#E5DDD0" />
      <rect x="40" y="220" width="200" height="80" rx="14" fill="#D6C9B2" />
      <path d="M270 320 L270 200 Q270 160 310 160 L360 160 L360 320 Z" fill="#F4EFE6" stroke="#D6C9B2" strokeWidth="1" />
      <rect x="80" y="80" width="80" height="80" rx="3" fill="#FAF6EF" stroke="#B5896F" strokeWidth="1" />
      <line x1="100" y1="120" x2="140" y2="100" stroke="#B5896F" strokeWidth="1" opacity="0.5" />
      <line x1="100" y1="140" x2="140" y2="120" stroke="#B5896F" strokeWidth="1" opacity="0.5" />
      <ellipse cx="350" cy="320" rx="14" ry="3" fill="#7C766E" opacity="0.4" />
      <path d="M340 318 Q340 300 350 300 Q360 300 360 318 Z" fill="#5A4434" />
